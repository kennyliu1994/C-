...
void assign_rank_and_crowding_distance(chromosome new_pop[])
{
    ...
    do
    {
        ...
        {
            new_pop[orig->child->index].rank = rank;
            new_pop[orig->child->index].crowd_dist = INF;
            break;
        }
        temp1 = orig->child;
        ...
        do
        {
            ...
            do
            {
                ...
                flag = check_dominance(new_pop[temp1->index], new_pop[temp2->index]);
                if (flag == 1)
                {
